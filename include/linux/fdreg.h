 ...
 */
#ifndef _FDREG_H/* 该定义处用来排除代码中重复包含此头文件	*/
#define _FDREG_H
...
/* Bits of main status register */ /* 主状态寄存器各位的含义。	*/
#define STATUS_BUSYMASK	0x0F /* drive busy mask */		/* 驱动器忙位(每位对应一个驱动器)。	*/
#define STATUS_BUSY	0x10	/* FDC busy */				/* 软盘控制器。	*/
...
/* Bits of FD_ST0 */ /* 状态字节(ST0)各比特位的含义	*/
...
#define ST0_ECE		0x10	/* Equipment chech error */	/* 设检测出错(零磁道校准出错).	*/
...
/* Bits of FD_ST1 */ /* 状态字节1(ST1)各比 特位的含义	*/
