...
/* 程序头在内存中的偏移位置。目标文件头结构末端到1024字节之间的长度。	*/
#define _N_HDROFF(x) (SEGMENT_SIZE - sizeof (struct exec))

/* 下面宏用于操作目标文件的内容，包括}模块文件和可执行文件。	*/
/* 代码部分起始偏移值。
...
/* 这里，Linux0.11内核把内存页定义为4KB，段大小定义为1KB。因此没有使用上面的定义。	*/
#define PAGE_SIZE 4096
...
#endif
#ifndef N_TYPE			/* 0xle(0b0001,1110)符号的类型位。	*/
#define N_TYPE	036
#endif
#ifndef N_STAB			/* STAB —符号表类型（Symbol table types）。	*/
#define N_STAB	0340	/* 0xe0(0blll0,0000)这几个比特用于符号调试器。	*/
#endif
...
/* This is output from LD.	*/	/* 下面是LD 的输出。	*/
...
struct relocation_info
{
	...
	*/
	...
	/* 没有使用的4 个比特位，但是当进行写一个目标文件时最好将它们复位掉。*/
